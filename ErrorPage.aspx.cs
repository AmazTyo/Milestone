...
namespace WebApplication1MileStone1
{
    public partial class ErrorPage : Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            // Log the exception.
            LogException(ex, errorHandler); // Replace with your own logging method

            // Clear the error from the server.
            Server.ClearError();
        }

        private void LogException(Exception ex, string errorHandler)
        {
            // Implement your own exception logging here
        }
    }
}